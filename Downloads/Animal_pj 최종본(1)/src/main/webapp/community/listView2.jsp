   ...
   <%@ include file="../css/header.jsp"%>
            ...
            <div class="table-responsive small">
                ...
                <div class="d-flex" style="float: right; margin: 40px;">
                    ...
                    <button type="button" class="btn btn-outline-success rounded-pill"
                        ...
                        data-bs-content="<a class='text-decoration-none' href='missingAnimalView.jsp'>실종동물 게시글 작성</a><br><a class='text-decoration-none' href='protectAnimal.jsp'>유기동물 보호 게시글 작성</a>">
                        <i class="bi bi-pencil me-1"></i>글 쓰기
                    </button>

                    <!-- 글쓰기 버튼 -->
                    <a href="${pageContext.request.contextPath}" class="button ms-3">
    ...
    <script type="text/javascript">
		...
		function adchange(status) {
		    ...
		    if (status === '유기동물 보호 게시판') {
		        ff.action = 'list.jsp'; // 유기동물 보호 게시판의 경우 list.jsp로 이동
		    } else if (status === '실종') {
		        ff.action = 'list2.jsp'; // 실종 카테고리의 경우 list2.jsp로 이동
		    }
